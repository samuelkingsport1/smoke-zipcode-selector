...
const AlertList = ({ alerts, title, onExport }) => {
    ...
    return (
        <div className="alert-list-container">
            <div className="alert-list-header">
                ...
                <button className="export-btn" onClick={onExport}>Export Target List</button>
            </div>
            <div className="alert-list-scroll">
                {alerts.map((alert, index) => {
                    ...
                    return (
                        <div key={props.id || index} className="alert-card">
                            ...
                            <div className="alert-card-body">
                                ...
                                {/* Description truncate could go here */}
                            </div>
                        </div>
                    );
                })}
